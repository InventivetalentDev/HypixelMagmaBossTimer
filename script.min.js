...
else console.warn("Browser does not support notifications")}function A(a,e){function d(){grecaptcha.execute("6LeaYLIUAAAAAHfC2C6GsI84CW5sJjuaZA9FERRE",{action:(a||"homepage").replace(/ /gi,"_")}).then(function(a){console.log("got recaptcha token");x=a;e(!0)});return!0}return 54E5<b.estimate-c?1==confirm("The next estimated spawn phase has not yet started. Are you sure you want add "+(a||"a spawn")+"?")?d():!1:d()}$("#infoModal").modal();$("#timelineModal").modal({onOpenEnd:function(){y()}});$(".track-btn.tooltipped").tooltip({position:"left"});
var x=null;grecaptcha.ready(function(){console.log("recaptcha ready");$(".track-btn").attr("disabled",!1)});var z=Math.floor(9*Math.random())+1;$("#bgImage").css("background-image","url(img/bg/"+z+".jpg), url(img/bg/"+z+".png)");var c=(new Date).getTime(),q=0,n,m,b={},u=-1,k=4,w=c/1E3,f="",g="";h();setInterval(h,3E4);v();setInterval(v,3E4);$("#waveBlazeBtn").click(function(){var a=$(this);e(a,"blaze","a blaze wave",!1)});$("#waveMagmaBtn").click(function(){var a=$(this);e(a,"magma","a magma wave",
!1)});$("#musicBtn").click(function(){var a=$(this);e(a,"music","music",!1)});$("#spawnedBtn").click(function(){var a=$(this);e(a,"spawn","a boss spawn",!1)});$("#deathBtn").click(function(){var a=$(this);e(a,"death","a boss death",!0)});$("#tenMinNotificationSwitch").prop("checked","true"===localStorage.getItem("tenMinNotification"));$("#tenMinNotificationSwitch").change(function(){$(this).is(":checked")?Notification.requestPermission().then(function(a){console.log(a);localStorage.setItem("tenMinNotification",
"true")}):localStorage.setItem("tenMinNotification","false")});$("#fiveMinNotificationSwitch").prop("checked","true"===localStorage.getItem("fiveMinNotification"));$("#fiveMinNotificationSwitch").change(function(){$(this).is(":checked")?Notification.requestPermission().then(function(a){console.log(a);localStorage.setItem("fiveMinNotification","true")}):localStorage.setItem("fiveMinNotification","false")});$("#mcUsername").val(localStorage.getItem("mcUsername")||"");$("#mcUsername").on("change",function(){localStorage.setItem("mcUsername",
$(this).val())});$("#timelineLoadMore").click(function(){24>k?k+=2:$(this).attr("disabled",!0);y()});$(window).on("focus blur",function(){w=Date.now()/1E3});$.getJSON("https://api.ipify.org?format=jsonp&callback=?",function(a){f=a.ip;console.log("IPv4: "+f)});$.getJSON("https://api6.ipify.org?format=jsonp&callback=?",function(a){g=a.ip;console.log("IPv6: "+g)})});
